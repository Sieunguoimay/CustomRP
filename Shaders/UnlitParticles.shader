Shader "Custom RP/Particles/Unlit"
{
    Properties
    {
        ...
        _SoftParticlesDistance("Soft Particle Distance", Range(0.0,10.0)) = 1.0
        _SoftParticlesRange("Soft Particles Range", Range(0.01,10.0)) = 1.0
        ...
        _DistortionBlend("Distortion Blend",Range(0.0,1.0))=1.0
